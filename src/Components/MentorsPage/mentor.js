    ...
    <div className="container">
      ...
      <div className="timeline" ref={timelineRef}>
        ...
        <div className="section" ref={(el) => (sectionsRef.current[2] = el)}>
          <div className="bead">
            <img
              src="https://res.cloudinary.com/diztvedtn/image/upload/v1739612296/hem0dnmqo43nuh9u9dkp.jpg"
              className="image"
            ></img>
          </div>
          <div className="content">
            <h2>Dr. Ankush Sawarkar</h2>
            <h2 className="title2">Faculty Coordinator, Zenith'25</h2>
            <p>
            &quot;Zenith'25 stands as the premier sports festival of SGGSIE&T,
              Nanded,featuring a myriad of sports competitions as both the
              inter-collegiate and intra-collegiate levels. It's golden
              opportunity to become an integral part of SGGS Team Zenith'25.This
              event offers a unique chance for you to enhance your leadership,
              confidence and patience.&quot;
            </p>
          </div>
        ...
        <div className="section" ref={(el) => (sectionsRef.current[3] = el)}>
          <div className="bead">
            <img
              src="https://res.cloudinary.com/diztvedtn/image/upload/v1739612086/pk6uxdnwvwtvgqlfe9jt.jpg"
              className="image"
            ></img>
          </div>
          <div className="content">
            <h2>Dr. Jeet Patil</h2>
            <h2 className="title2">Faculty Co-cordinator, Zenith'25</h2>
            <p>
